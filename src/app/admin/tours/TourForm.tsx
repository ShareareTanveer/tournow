...
export default function TourForm({ destinations, tour }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    inclusions: fromArr(tour?.inclusions),
    exclusions: fromArr(tour?.exclusions),
        ...
        {tab === 'basic' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {inp('price', 'Price (LKR) *', 'number', '250000', true)}
              {inp('oldPrice', 'Old Price (LKR)', 'number', '300000')}
        ...
        {tab === 'content' && (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {area('inclusions', 'Inclusions (one per line)', 5)}
              {area('exclusions', 'Exclusions (one per line)', 5)}
