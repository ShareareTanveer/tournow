        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input required value={form.visaType} onChange={(e) => setForm({ ...form, visaType: e.target.value })}
              placeholder="Tourist, Business, Transit…" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-orange-400" />
          </div>
          <div>
            ...
            <input value={form.processingTime} onChange={(e) => setForm({ ...form, processingTime: e.target.value })}
              placeholder="3–5 working days" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-orange-400" />
          </div>
        </div>
        <div>
